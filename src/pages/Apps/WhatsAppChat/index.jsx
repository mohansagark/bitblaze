  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://bitblaze.vercel.app/whatsapp-chat"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Send WhatsApp Message Without Saving Number"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://bitblaze.vercel.app/whatsapp-chat"
        />
        <meta
          property="og:image"
          content="https://bitblaze.vercel.app/thumbnail.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="Send WhatsApp Without Saving Number"
        />
        <meta
      ...
      <Container center>
        <div className="w-full max-w-sm p-6 rounded-xl shadow-md flex flex-col gap-6 bg-[var(--color-surface)] text-[var(--color-surface-text)]">
          ...
          <Typography variant="body2" className="text-neutral-400 text-center">
            Use this free tool to instantly open WhatsApp chats with unsaved
            numbers. No app install needed. Just enter a mobile number and click
            Send.
          </Typography>
